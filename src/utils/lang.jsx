export const lang = {
    "en": {
        ...
        prompts: {
            "askPrice": "Please enter a price to sell (1 = 1 over). A 1% transaction fee will be charged when the trade is executed.",
            "askConfirm": "Are you sure you want to create an order to sell Token %s for %s OVER? A 1% transaction fee will be charged when the trade is executed.",
            ...
            "approveAll": "Approve the Exchange contract to manage all your %s NFTs. This is required only once.",
            "cancelApproval": "Cancel the approval for the Exchange contract to manage all your %s NFTs.",
        },
        tooltips: {
        },
        etc: {
    ...
    "ko": {
        ...
        prompts: {
            "askPrice": "판매 가격을 입력하세요 (1 = 1 over). 거래 발생이 되면 1%의 수수료가 부과됩니다.",
            "askConfirm": "Token %s를 %s OVER에 판매하는 주문을 생성하시겠습니까? 거래 발생이 되면 1%의 수수료가 부과됩니다.",
            ...
            "approveAll": "Exchange 컨트랙트가 귀하의 모든 %s NFT를 관리할 수 있도록 승인합니다. 이는 매번 approve 하는 절차를 생략하기 위해 사용합니다.",
            "cancelApproval": "Exchange 컨트랙트가 귀하의 모든 %s NFT를 관리할 수 있도록 승인했던 것을 취소합니다.",
        },
        tooltips: {
        },
        etc: {
